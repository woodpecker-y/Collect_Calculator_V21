...
系统默认参数数据初始化
*/
#define SYSTEM_BulidTime            0X20181223			//系统编译日期
#define SYSTEM_VERSION              20181223            //采集器软件版本号（32位无符号整数）
...
#define MAXBuldMeter_Num			(8)                 //系统最大楼栋热表容量
...
#define USE_POWRELAY			1                     	//定义是否启用主回路控制继电器  "1":启用  "0":不启用
