...
#define configSUPPORT_DYNAMIC_ALLOCATION			1  //为1时支持动态内存申请
...
#define configTOTAL_HEAP_SIZE						((size_t)1024ul*48)
#define configMAX_TASK_NAME_LEN                  	( 32 )
#define configUSE_16_BIT_TICKS						0
#define configIDLE_SHOULD_YIELD						0
#define configUSE_MUTEXES							1
#define configQUEUE_REGISTRY_SIZE					16     //不为0时表示启用队列记录，具体的值是可以
#define configUSE_APPLICATION_TASK_TAG				1      //1使用任务标记
...
#define configUSE_CO_ROUTINES                    0      //配置是否使用协程
